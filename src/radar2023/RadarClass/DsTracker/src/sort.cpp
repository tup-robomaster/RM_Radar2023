    ...
    float matching_threshold, int budget)
{
    ...
    {
        _metric =
            &NearestNeighborDistanceMetric::_nneuclidean_distance;
    }
    else if (metric == cosine)
    {
        _metric =
            &NearestNeighborDistanceMetric::_nncosine_distance;
    }
...
void NearestNeighborDistanceMetric::partial_fit(
...
Eigen::MatrixXf
NearestNeighborDistanceMetric::_pdist(const FEATURESS &x, const FEATURESS &y)
{
...
Eigen::MatrixXf
NearestNeighborDistanceMetric::_cosine_distance(
